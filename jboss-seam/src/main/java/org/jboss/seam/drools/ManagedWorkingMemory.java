...
public class ManagedWorkingMemory implements Mutable, Serializable {
	...
	private ValueExpression<org.drools.core.RuleBase> ruleBase;
	...
	/**
	 * The name of a Seam context variable holding an instance of
	 * org.drools.RuleBase
	 * 
			...
			for (String eventListener : eventListeners) {
				...
				try {
					...
					if (eventListenerObject instanceof WorkingMemoryEventListener) {
						...
						// } else if (eventListenerObject instanceof RuleEventListener) {
						// statefulSession.addEventListener((RuleEventListener) eventListenerObject);
					} else {
	...
	protected org.drools.core.RuleBase getRuleBaseFromValueBinding() {
		org.drools.core.RuleBase ruleBase;
		if (this.ruleBase != null) {
			ruleBase = this.ruleBase.getValue();
		} else if (ruleBaseName != null) {
			// deprecated stuff
			ruleBase = (org.drools.core.RuleBase) Component.getInstance(ruleBaseName, true);
		} else {
	...
	public ValueExpression<org.drools.core.RuleBase> getRuleBase() {
		return ruleBase;
	}

	public void setRuleBase(ValueExpression<org.drools.core.RuleBase> ruleBase) {
