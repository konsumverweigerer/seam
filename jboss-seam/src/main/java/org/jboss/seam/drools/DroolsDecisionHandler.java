...
/**
 * A jBPM DecisionHandler that delegates to a Drools WorkingMemory held in a
 * Seam context variable. The decision outcome is returned by setting the
 * outcome attribute of the global named "decision".
 * 
 * @author Gavin King
 *
 */
public class DroolsDecisionHandler extends DroolsHandler implements DecisionHandler {
	...
	public String decide(ExecutionContext executionContext) throws Exception {
		WorkingMemory workingMemory = getWorkingMemory(workingMemoryName, assertObjects, retractObjects,
				executionContext);
