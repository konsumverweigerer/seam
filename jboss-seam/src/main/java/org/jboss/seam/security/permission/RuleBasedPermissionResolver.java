...
/**
 * A permission resolver that uses a Drools rule base to perform permission
 * checks
 * 
 * @author Shane Bryzak
 */
...
public class RuleBasedPermissionResolver implements PermissionResolver, Serializable {
	 ...
	 * 
	 * @param target
	 *            Object The target of the permission check
	 * @param action
	 *            String The action to be performed on the target
	...
	public static RuleBasedPermissionResolver instance() {
		...
		RuleBasedPermissionResolver instance = (RuleBasedPermissionResolver) Component
				.getInstance(RuleBasedPermissionResolver.class, ScopeType.SESSION);
